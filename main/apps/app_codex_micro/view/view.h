...
private:
    ...
    static void usageActionEvent(lv_event_t* event);
    ...
    void renderUsage(lv_obj_t* parent);
    void updateUsagePage();
    ...
    // Usage page widgets: index 0 = Claude, index 1 = Codex.
    std::array<lv_obj_t*, 2> _usage_arcs                     = {};
    std::array<lv_obj_t*, 2> _usage_pct_labels               = {};
    std::array<lv_obj_t*, 2> _usage_reset_labels             = {};
    std::array<lv_obj_t*, 2> _usage_week_bars                = {};
    std::array<lv_obj_t*, 2> _usage_week_labels              = {};
    lv_obj_t* _usage_status_label                            = nullptr;
    std::array<IconContext, 3> _usage_action_contexts        = {};
    uint32_t _usage_last_update_tick                         = 0;
    bool _usage_offline_view                                 = false;
    static constexpr std::array<const char*, 3> UsageActions = {"focus", "enter", "esc"};
